...
!(function () {
  ...
  ((t.prototype.TYPES = ['line', 'ellipse', 'circle', 'polygon', 'polyline', 'rect']),
    ...
    (t.prototype.pathMaker = function (t, e) {
      ...
      for (r = 0; r < t.attributes.length; r++)
        ((n = t.attributes[r]),
          -1 === this.ATTR_WATCH.indexOf(n.name) && i.setAttribute(n.name, n.value));
  ...
  ((e.LINEAR = function (t) {
        ...
        case window.HTMLObjectElement:
          ...
          ((i = this),
            (n = function (e) {
              if (!i.isReady) {
                if (
                  ((i.el = t.contentDocument && t.contentDocument.querySelector('svg')), !i.el && e)
                )
    ...
    (e.prototype.drawer = function () {
      ...
      (this.callback(this),
        this.instanceCallback && (this.instanceCallback(this), (this.instanceCallback = null)));
    }),
    (e.prototype.trace = function () {
      var t, e, r, n;
      for (
        n = this.animTimingFunction(this.currentFrame / this.frameLength) * this.frameLength, t = 0;
        t < this.map.length;
        t++
      )
        ((r = this.map[t]),
    ...
    (e.prototype.play = function (t, e) {
      ...
      return (
        e && 'function' == typeof e && !this.instanceCallback && (this.instanceCallback = e),
        (this.speed = t || 1),
